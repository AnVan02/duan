...
?>
    <header class="main-header" style="position: fixed;width:100%;">
        ...
        <a href="index.php" class="logo position-fixed" >
            ...
            <span class="logo-mini"><b>Tin Hoc</b>Viết Sơn</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b> Tin Học Viết Sơn</b></span>
        </a>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?controller=feedbacks">
                        <i class="fa fa-comment"></i> <span> Ý kiến khách hàng</span>
                    </a>
                </li>
                <?php endif;?>
    ...
    <footer class="main-footer">
        ...
        <strong><script>document.write(new Date().getFullYear());</script> Bản quyền thuộc về công ty cổ phần tin học &copy;<a href="https://vietson.com">Viết Sơn</a>.</strong>
