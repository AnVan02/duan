                    ...
                    <div class="product-grid bg-light">
                        ...
                        <?php foreach($dataProducts as $products):?>
                            <div class="product-item bg-light w-25">
                                ...
                                <div class="red_button add_to_cart_button"><a href="index.php?controller=products&action=productDetail&id=<?php echo $products->id ?>">Liên hệ </a></div>
                            </div>
                        <?php endforeach; ?>
                        <?php else:?>
                            <div class="col font-italic" style="margin-left: 10px;"><h4>Không còn sản phẩm nào cả</h4></div>
                        <?php endif;?>
                    </div>
                    <?php if(!empty($dataProducts)):?>
