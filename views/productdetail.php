	...
	<div class="row pb-5">
		...
		<div class="col-lg-5">
			<div class="product_details">
				...
				<?php 
					if ($dataProducts->price > 0) {
					if($dataProducts->discount > 0) {
						$price = number_format(round($dataProducts->price * (100 - $dataProducts->discount) / 100, -3));
						echo '<div class="original_price">Giá gốc: '.number_format($dataProducts->price).' ₫</div>';
					...
					echo 'Giá: <div id="price" class="product_price">Liên hệ</div>';
				...
				<div class="quantity d-flex  flex-sm-row align-items-sm-center">
					...
					<div class="red_button pl-2 pr-3" ><a id="add_to_cart"  class="text-white">Liên hệ</a></div>
					...
					<div class="col-lg-6 add_review_col reviews_title">
						<?php if(empty($_SESSION['customer_id'])):?>
							<h5 class="font-italic mt-2">
								<a href="index.php?controller=login&action=login"></a>
							</h5>
						<?php else:?>
