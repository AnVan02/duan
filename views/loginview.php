...
<html lang="en">
<head>
<title>CÔNG TY TIN HOC VIẾT SƠN</title>
<meta charset="utf-8">
        ...
        <div class="card bg-white text-dark" style="border-radius: 1rem; ">
          <div class="card-body p-5 text-center">
			<form method="post" action="index.php?controller=login&action=login">
				...
				<h2 class="fw-bold mb-2 text-uppercase"><a href="index.php"><span style="color: #fe4c50;">Tin Học</span><span style="color: black;">VIẾT SƠN</span></a></h2>
